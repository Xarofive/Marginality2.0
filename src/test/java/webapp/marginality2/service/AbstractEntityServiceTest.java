...
class AbstractEntityServiceTest {
    ...
    @Test
    void testCreateEgg() {
        Egg egg = new Egg(1, "Fresh Egg", 20, Status.SOLD, 100, null);
    ...
    @Test
    void testUpdateEgg() {
        Egg existingEgg = new Egg(1, "Old Egg", 15, Status.EXPIRED, 50, null);
        Egg updatedEgg = new Egg(1, "Updated Egg", 25, Status.EXPIRED, 75, null);
        ...
        StepVerifier.create(eggService.update(existingEgg.getId(), updatedEgg))
                .expectNextMatches(newEgg -> newEgg.getName().equals("Updated Egg") && newEgg.getStatus() == Status.EXPIRED && newEgg.getCount() == 75)
                .verifyComplete();
    }

    @Test
    void testFindById() {
        Egg egg = new Egg(1, "Fresh Egg", 20, Status.EXPIRED, 100, null);
    ...
    @Test
    void testFindAll() {
        Egg egg1 = new Egg(1, "Egg One", 10, Status.EXPIRED, 30, null);
        Egg egg2 = new Egg(2, "Egg Two", 15, Status.EXPIRED, 40, null);
