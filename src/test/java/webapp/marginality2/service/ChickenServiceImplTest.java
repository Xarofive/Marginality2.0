...
class ChickenServiceImplTest {
    ...
    void testCreateChicken() {
        Chicken chicken = new Chicken(1, "Free Range Chicken", 100, true, 50, null);
    ...
    void testUpdateChicken() {
        Chicken existingChicken = new Chicken(1, "Old Chicken", 50, true, 30, null);
        Chicken updatedChicken = new Chicken(1, "Updated Chicken", 75, false, 25, null);
    ...
    void testFindAllChickens() {
        Chicken chicken1 = new Chicken(1, "Chicken One", 80, true, 40, null);
        Chicken chicken2 = new Chicken(2, "Chicken Two", 90, false, 60, null);
