...
class MeatServiceImplTest {
    ...
    @Test
    void testCreateMeat() {
        Meat meat = new Meat(1, "Beef", 200, true, 50, null);
    ...
    @Test
    void testUpdateMeat() {
        Meat existingMeat = new Meat(1, "Pork", 150, true, 40, null);
        Meat updatedMeat = new Meat(1, "Updated Pork", 180, false, 35, null);
    ...
    void testFindAllMeats() {
        Meat meat1 = new Meat(1, "Beef", 200, true, 50, null);
        Meat meat2 = new Meat(2, "Chicken", 100, false, 75, null);
